...
export interface ExamContractInterface extends utils.Interface {
  functions: {
    ...
    "careers(uint256)": FunctionFragment;
    ...
    "studentIds(address)": FunctionFragment;
    "subjects(uint256)": FunctionFragment;
  };
  ...
  decodeFunctionResult(functionFragment: "careers", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "deleteStudent",
    data: BytesLike
  ): Result;
...
export interface ExamContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExamContractInterface;
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { studentId: BigNumber }>;
